...
public class Highsc {
	...
	private void initialize() {
		...
		txtpnHowToPlay.setText("High Scores");
		txtpnHowToPlay.setBounds(184, 39, 195, 48);
		panel.add(txtpnHowToPlay);
		
		JLabel label_1 = new JLabel("");
		Image img1 = new ImageIcon(this.getClass().getResource("/score.JPG")).getImage();
		...
		btnNewButton_4.setBounds(0, 0, 23, 23);
